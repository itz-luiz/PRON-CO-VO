...
async function loadEquipamentosData() {
    ...
    try {
        const response = await fetch('https://pron-co-vo.onrender.com/equipamentosPublicos');
...
async function loadTransporteData() {
    ...
    try {
        const response = await fetch('https://pron-co-vo.onrender.com/pontosDeTransporte');
        const data = await response.json();
        data.forEach(ponto => {
...
async function fetchEquipamentos() {
    const res = await fetch('https://pron-co-vo.onrender.com/equipamentosPublicos');
...
form.onsubmit = async function(e) {
    ...
    const url = id ? `https://pron-co-vo.onrender.com/equipamentosPublicos/${id}` : 'https://pron-co-vo.onrender.com/equipamentosPublicos';
...
window.editEquip = async function(id) {
    const res = await fetch(`https://pron-co-vo.onrender.com/equipamentosPublicos/${id}`);
    const data = await res.json();
...
window.deleteEquip = async function(id) {
    if (confirm('Tem certeza que deseja excluir este equipamento?')) {
        await fetch(`https://pron-co-vo.onrender.com/equipamentosPublicos/${id}`, { method: 'DELETE' });
        fetchEquipamentos();
        loadEquipamentosData();
    }
};
